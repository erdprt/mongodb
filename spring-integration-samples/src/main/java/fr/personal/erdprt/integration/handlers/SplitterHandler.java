...
import fr.personal.erdprt.integration.splitters.Splitter;

public class SplitterHandler implements IListener {

	private static Logger logger	=	LoggerFactory.getLogger(SplitterHandler.class);
